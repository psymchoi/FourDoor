        ...
        else
        {
            switch(_monsterAction)
            {
                case eMonsterAction.WALK:
                    ...
                    else if(Vector3.Distance(transform.position, MonsterSpawnControl._uniqueInstance.ROOTROAM.position) < 7.0f
                ...
                case eMonsterAction.CLOWN_TryOPEN:
                    ...
                    else if (Vector3.Distance(transform.position, _tfPlayer.position) < 10.0f)
                    {
